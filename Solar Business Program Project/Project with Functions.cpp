...
// This function calculates the project price based on system capacity
...
// This function sorts customers alphabetically by name using bubble sort
void sortCustomers()
{
...
// This function sorts products alphabetically by name using bubble sort
void sortProducts()
{
...
// This function prints a single customer's details nicely
...
void addCustomer()
{
    ...
    customerprojectprice[newIndex] = calculatePrice(customersolarsystemcapacity[newIndex]);
    customerCount++;
    ...
    for (int i = 0; i < customerCount; i++)
    {
        ...
        if (match)
        {
            ...
            else if (fieldChoice == 8)
            {
                ...
                cin.ignore();
                customerprojectprice[i] = calculatePrice(customersolarsystemcapacity[i]);
...
// This function handles the whole customer management menu
void customerManagement()
{
    while (true)
    {
        ...
        else if (subChoice == 2) viewCustomers();
        else if (subChoice == 3) updateCustomer();
        else if (subChoice == 4) deleteCustomer();
        else if (subChoice == 5) searchCustomer();
        else if (subChoice == 6)
        {
            system("cls");
...
// This function handles the whole inventory management menu
void inventoryManagement()
{
    while (true)
    {
        ...
        if      (subChoice == 1) addProduct();
        else if (subChoice == 2) viewProducts();
        else if (subChoice == 3) updateProduct();
        else if (subChoice == 4) deleteProduct();
        else if (subChoice == 5) searchProduct();
        else if (subChoice == 6)
        {
            system("cls");
            cout << "Returning to Admin Menu..." << endl;
...
void updateOrderStatus()
{
    ...
    else
    {
        ...
        if      (statusChoice == 1) { orderStatus[idx] = "Pending";   cout << "Status updated to: Pending"   << endl; }
        else if (statusChoice == 2) { orderStatus[idx] = "Confirmed"; cout << "Status updated to: Confirmed" << endl; }
        else if (statusChoice == 3) { orderStatus[idx] = "Delivered"; cout << "Status updated to: Delivered" << endl; }
        else if (statusChoice == 4) { orderStatus[idx] = "Cancelled"; cout << "Status updated to: Cancelled" << endl; }
...
// This function handles the whole order management menu
void orderManagement()
{
    while (true)
    {
        ...
        if      (subChoice == 1) createOrder();
        else if (subChoice == 2) viewOrders();
        else if (subChoice == 3) updateOrderStatus();
        else if (subChoice == 4) deleteOrder();
        else if (subChoice == 5)
        {
            system("cls");
            cout << "Returning to Admin Menu..." << endl;
...
void setupCalculation()
{
    ...
    cout << "---------------------------------"                                     << endl;
    cout << "Total Estimated Cost : " << calculatePrice(SolarsystemCapacity)       << " PKR" << endl;
...
// This function handles the whole reports menu
void reportsMenu()
{
    while (true)
    {
        ...
        if      (subChoice == 1) customerSummaryReport();
        else if (subChoice == 2) inventoryReport();
        else if (subChoice == 3) ordersReport();
        else if (subChoice == 4) revenueReport();
        else if (subChoice == 5)
        {
            system("cls");
            cout << "Returning to Admin Menu..." << endl;
...
void adminMenu()
{
    ...
    if (adminUsername == "admin" && adminPassword == "123")
    {
        ...
        while (true)
        {
            ...
            if      (choice == 1) customerManagement();
            else if (choice == 2) inventoryManagement();
            else if (choice == 3) orderManagement();
            else if (choice == 4) setupCalculation();
...
// This function handles the customer portal menu
void customerPortal()
{
    system("cls");
    ...
    if      (custChoice == 1) getQuotation();
    else if (custChoice == 2) viewMyQuotation();
    else if (custChoice == 3) { system("cls"); }
    else
    {
        cout << "Enter a valid input. And press any key to try again." << endl;
        getch();
...
int main()
{
    ...
    while (true)
    {
        ...
        else if (choice == 2) customerPortal();
        else if (choice == 3)
        {
            system("cls");
